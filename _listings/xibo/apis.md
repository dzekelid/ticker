...
- name: Xibo API
  ...
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ticker/master/_listings/xibo/playlistwidgettickerplaylistid-post-openapi.md
- name: Xibo API
  x-api-slug: xibo-api
  description: Xibo Digital Signage is a low-cost, high performance solution to launch
    your business, workplace or organisation into the future. Xibo doesn&rsquo;t just
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/ticker/master/_listings/xibo/openapi.md
x-common:
- type: x-blog-rss
